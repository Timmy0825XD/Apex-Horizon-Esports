...
El transcript es una **foto HTML** del canal en el momento del archivo. Vive en Discord (canal de transcripts del torneo). Si se pierde el mensaje, se perdió el archivo.
