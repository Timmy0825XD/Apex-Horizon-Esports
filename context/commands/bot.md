...
**Para qué:** Mapa de comandos por sección y quién puede usarlos. El heading de cada página es el comando raíz de esa familia. Los de `/bot`, `/settings`, `/server`, `/staff`, `/tournament`, `/team` y `/utility` se mencionan como slash; el resto del catálogo va en monospace hasta que existan en Discord.
