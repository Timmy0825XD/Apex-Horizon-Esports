...
- No es el formulario de inscripción. Los capitanes escriben en la hoja; el bot **lee y valida**. Guarda **copias globales** de esas hojas para `/tournament find_player`; la Google Sheet sigue siendo la verdad al operar el torneo.
