...
| **Organiser** (rol manager del servidor) | Opera el torneo a nivel de salas, tickets, roles masivos, bans de usuario, muchas acciones de bracket |
...
| **Público** | Consultas que no mutan estado (info de servidor, headers de hoja, ping, about/help, team info según reglas) |
