...
export const helpCatalog: HelpCategory[] = [
  ...
  },
  {
    ...
    entries: [
      { slash: "tournament add", summary: "Register a tournament (bracket, sheet, rooms, channels).", access: "Admin" },
      { slash: "tournament edit", summary: "Patch that tournament world.", access: "Admin" },
      { slash: "tournament delete", summary: "Forget the tournament config. Does not delete Discord channels.", access: "Admin" },
